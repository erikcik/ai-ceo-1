...
run BLOCK frozen-guard.sh "$(write_call '.claude/commands/start.md')"              "Write a slash command"
run BLOCK frozen-guard.sh "$(write_call '.claude/agents/rubric-reviewer.md')"      "Write rubric-reviewer.md"
